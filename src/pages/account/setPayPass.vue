...
<template>
  <div class='edit-pass'>
    ...
    <div class="input-wrap">
      <p>交易密码</p>
      <div class="input-box">
        <input type="password" placeholder="请我输入交易密码" v-model="newPassword">
      </div>
    </div>
    <div class="input-wrap">
      <p>确认密码</p>
    ...
    <!--<router-link to='/account/forgetPayPass' tag='p' class="forget-btn">忘记密码？</router-link>-->
  ...
  export default {
    ...
    methods: {
      edit() {
        ...
        this.axios.post('/User/setSafetyPwd', {
          safe_password: this.newPassword,
          re_safe_password: this.reNewPassword,
